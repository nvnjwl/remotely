var API_BASE_TEMPLATE = `(function () {
...
window.SCRIPT_TEMPLATES_LIST["API_BASE_TEMPLATE"] = API_BASE_TEMPLATE;

// Update the template definition
if (window.SCRIPT_TEMPLATES && window.SCRIPT_TEMPLATES.API_BASE_TEMPLATE) {
	window.SCRIPT_TEMPLATES.API_BASE_TEMPLATE.code = API_BASE_TEMPLATE;
}